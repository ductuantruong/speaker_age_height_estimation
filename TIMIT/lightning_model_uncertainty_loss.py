...
class LightningModel(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        x, y_h, y_a, y_g, x_len, weight = batch
        ...
        loss = self.uncertainty_loss(torch.cat((y_hat_h, y_hat_a, y_hat_g)), torch.cat((y_h, y_a, y_g)), weight)
...
class LightningModelAge(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        loss = self.uncertainty_loss(torch.cat((y_hat_a, y_hat_g)), torch.cat((y_a, y_g)), weight)
...
class LightningModelHeight(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        loss = self.uncertainty_loss(torch.cat((y_hat_h, y_hat_g)), torch.cat((y_h, y_g)), weight)
