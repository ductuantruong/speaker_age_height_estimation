...
class LightningModel(pl.LightningModule):
    def __init__(self, HPARAMS):
        ...
        self.model = self.models[HPARAMS['model_type']](upstream_model=HPARAMS['upstream_model'], num_upstream_encoder=HPARAMS['num_upstream_encoder'], num_layers=HPARAMS['num_layers'], feature_dim=HPARAMS['feature_dim'])
